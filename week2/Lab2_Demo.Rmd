...
```
on average, 3.7 more negative words per article than positive words
...
ggplot(sent_article, aes( x= idi)) +
  theme_classic() + 
  geom_col(aes(y = positive), stat = 'identity', fill = 'red4')+
  geom_col(aes(y = negative), stat = 'identity', fill = 'slateblue')+
